...
module DearImGui.Raw.ImDrawCmd where
...
-- C: ImTextureID GetTexID(const ImDrawCmd* self)
foreign import capi unsafe "dcimgui_nodefaultargfunctions.h ImDrawCmd_GetTexID"
  imDrawCmd_GetTexID :: (Ptr ImDrawCmd) -> IO ImTextureID
