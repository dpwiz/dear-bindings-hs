...
module DearImGui.Raw.ImTextureRef where
...
-- C: ImTextureID GetTexID(const ImTextureRef* self)
foreign import capi unsafe "dcimgui_nodefaultargfunctions.h ImTextureRef_GetTexID"
  imTextureRef_GetTexID :: (Ptr ImTextureRef) -> IO ImTextureID
